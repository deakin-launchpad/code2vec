...
from config import Config #VocabType
from argparse import ArgumentParser
from interactive_predict_c import InteractivePredictor
from model_base import Code2VecModelBase  #Model
import sys
import os
#import ptvsd
...
if __name__ == '__main__':
    ...
    config = Config(set_defaults=True, load_from_args=True, verify=True)  # get_default_config(args)

    model = load_model_dynamically(config)  # Model(config)
    print('Created model')
